          ...
          <Col md={6} sm={12}>
            <Fade left={isDesktop} bottom={isMobile} duration={1000} delay={1000} distance="30px">
              <div className="about-wrapper__info">
                ...
                <p className="about-wrapper__info-text">
                  {paragraphTwo ||
                    '일은 다소 단순한 DB 검색 및 유지보수 등의 전산실 업무 뿐이라 5년 후의 제 모습이 기대되지 않았습니다. 개인의 성장을 원하여 이직을 생각하였지만 요즘 이슈인 직고용 대상기업 중 하나였기에 회사내부 사정과 맞물려 퇴사를 결정하게 되었습니다. 이후 Front 개발을 배우고 있습니다.'}
                </p>
                <p className="about-wrapper__info-text">
